...
import cst8218.boby0003.entity.SpriteFacade;
import boby0003.util.JsfUtil;
import boby0003.util.PaginationHelper;
...
/**
 * Purpose: The purpose of this class is to control the Sprites in the system. It uses a Session Scoped Attribute so that whenever the browser is
 * up it will have only this one instance of the controller.  
 * 
 * @author Pat
 */
...
public class SpriteController implements Serializable {
    ...
    /**
     * Purpose: The purpose of this class is to Convert the Sprite object to a string or to convert a string to a Sprite object.
     */
